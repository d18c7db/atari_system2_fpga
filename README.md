...
>>>>>>> 6f6656eeef01651f9d32b4767f043a552288d493
...
It shoul dbe mentioned that in order to keep the MAME and simulation in sync the VBLANK signal has to be manually adjusted in the simulation to match the timing of MAME (which is notoriously not accurate to the real life arcade timing due to MAME being an emulator).
